...
\begin{figure*}
    ...
    \textit{Right columns:} comparison between the power-law ($\alpha=-1.4$) and exponential ($\uptau_{\rm Ia}=3$ Gyr) DTDs with the inside-out SFH. [Add: noticeable but subtle change in inner-galaxy peak and tail between DTDs]}
...
\begin{itemize}
    ...
    \item [Evidence for metallicity-dependent rates of SNe Ia \citet{Gandhi2022-MetallicityDependentRates,Johnson2023-Binaries} and CC SNe \citep{Pessi2023-MetalDepCCSNe}].
\end{itemize}
...
\begin{acknowledgments}
    ...
    LOD and JAJ acknowledge support from NSF grant 2307621. JAJ and JWJ acknowledge support from NSF grant 1909841.
