...
\begin{figure*}
    ...
    \caption{Similar to Figure \ref{fig:ofe-feh-sfh} but comparing multi-zone simulations with different DTD models. All assume an inside-out SFH. Each row contains star particles from a different }
