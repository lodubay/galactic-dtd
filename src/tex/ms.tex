...
% [Concluding sentence about how understanding the DTD is important for chemical evolution and for understanding the progenitors of SNe Ia]
...
% Type Ia supernovae (SNe Ia), the explosions of carbon-oxygen white dwarfs (WDs), are responsible for roughly half of the iron produced in the Galaxy [cite]. Despite their importance, 
