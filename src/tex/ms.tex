...
\begin{figure}
    ...
    \caption{The [O/Fe]--[Fe/H] plane for multiple Galactocentric regions from the model with the inside-out SFH and plateau ($W=0.3$ Gyr) DTD. The two columns of panels contain stars in different bins of $R_{\rm gals}$, and each row contains stars from a different bin of $|z|$. The contents of each panel is as described in Figure \ref{fig:ofe-feh-sfh}.}
...
% Instead of reporting the numerical scores for each simulation output, 
