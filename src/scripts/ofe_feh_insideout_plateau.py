"""
Compare [O/Fe]-[Fe/H] plots for the inner and outer Galaxy in the inside-out
SFH + plateau (W=1 Gyr) DTD model.
"""
...
def main(cmap_name='winter_r', style='paper'):
    ...
    plt.savefig(paths.figures / 'ofe_feh_insideout_plateau')
    plt.close()    
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        ...
        description='Compare [O/Fe]-[Fe/H] plots for the inner and outer ' +
        'Galaxy in the inside-out SFH + plateau (W=1 Gyr) DTD model.',
        )
