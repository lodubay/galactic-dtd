...
FIGSIZE = (5, 6)
FEH_LIM = (-2.6, 1)
OFE_LIM_LIST = [(-0.1, 0.6), (-0.1, 0.65), (-0.2, 0.5), (-0.2, 0.5)]
CMAP = "plasma_r"
LABELS = ["Late-burst SFH", "Conroy+ 2022 SFE", "Two-infall w/ migration", "Two-infall no migration"]
...
def setup_axes(figsize=(4, 4), xlim=(-3, 1), 
    ...
    for (ax, galr_lim) in zip(axs[0,:], galr_bins):
        ...
        ax.text(-2.4, 0.55, galr_label, size=8, va="top")
    # Tick marks
