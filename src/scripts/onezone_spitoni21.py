...
class spitoni21_gradient(models.spitoni21):
...
def main(overwrite=True):
    ...
    for galr in RADII:
        ...
        sz = vice.singlezone(name=output,
                             tau_star=models.spitoni21_tau_star(area, galr_mean),
                             func=spitoni21_gradient(galr_mean),
    ...
    fig.savefig(paths.figures / 'onezone_spitoni21.png', dpi=300)
